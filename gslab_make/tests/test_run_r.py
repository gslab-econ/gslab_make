...
class testRunR(unittest.TestCase):
    ...
    def test_default_log(self):
        with nostderrout():
            run_r(program = 'gslab_make/tests/input/R_test_script.R')      
    ...
    def test_default_log_install(self):
        with nostderrout():
            run_r(package = 'gslab_make/tests/input/rinstall_test_package/Ecdat_0.1-6.1.tar.gz')
    ...
    def test_custom_log(self):
        ...
        with nostderrout():
            start_makelog(makelog_file)
            run_r(program = 'gslab_make/tests/input/R_test_script.R', makelog = makelog_file)
        self.assertIn('Test script complete', open(makelog_file, 'rU').read())
        self.assertTrue(os.path.isfile('output.txt'))
        
    def test_independent_log(self):
        with nostderrout():
            run_r(program = 'gslab_make/tests/input/R_test_script.R', log = '../log/R.log')
    ...
    def test_executable(self):
        with nostderrout():
            run_r(program = 'gslab_make/tests/input/R_test_script.R', executable = 'R CMD BATCH') 
        self.assertIn('Test script complete', open('../log/make.log', 'rU').read())
        self.assertTrue(os.path.isfile('output.txt'))
        
    def test_bad_executable(self):
        with nostderrout():
            run_r(program = 'gslab_make/tests/input/R_test_script.R', executable = 'nonexistent_R_executable')
        self.assertNotIn('Test script complete', open('../log/make.log', 'rU').read())
   
    def test_no_program(self):
    	with self.assertRaises(Exception):
             run_r(program = 'gslab_make/tests/input/nonexistent_R_script.R')
        with nostderrout():
            run_r(program = 'gslab_make/tests/input/nonexistent_R_script.R')
    ...
    def test_option(self):
        with nostderrout():
            run_r(program = 'gslab_make/tests/input/R_test_script.R', option = '--no-timing')
        logfile_data = open('../log/make.log', 'rU').read()
        self.assertIn('Test script complete', logfile_data)
    ...
    def test_two_option(self):
        with nostderrout():
            run_r(program = 'gslab_make/tests/input/R_test_script.R', option = '--no-timing --slave')
        logfile_data = open('../log/make.log', 'rU').read()
        self.assertIn('Test script complete', logfile_data)
    ...
    def test_option_install(self):
        ...
        with nostderrout():
            run_r(package = 'gslab_make/tests/input/rinstall_test_package/Ecdat_0.1-6.1.tar.gz', lib = '../output/', option = '--no-data')
    ...
    def test_r_error(self):
        with nostderrout():
            run_r(program = 'gslab_make/tests/input/R_test_script_error.R')
    ...
    def test_specify_lib(self):
        ...
        self.assertFalse(os.path.isfile('../output/Ecdat/INDEX'))       
        with nostderrout():
            run_r(package = 'gslab_make/tests/input/rinstall_test_package/Ecdat_0.1-6.1.tar.gz', lib = '../output/')
        self.assertIn('* DONE (Ecdat)', open('../log/make.log', 'rU').read())
        self.assertTrue(os.path.isdir('../output/Ecdat/'))
        self.assertTrue(os.path.isfile('../output/Ecdat/INDEX'))    
