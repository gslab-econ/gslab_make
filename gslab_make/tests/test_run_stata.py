...
class testRunStata(unittest.TestCase):
    ...
    def test_default_log(self):
        ...
        with nostderrout():
            ...
            run_stata(program = 'gslab_make/tests/input/stata_test_script.do')
    ...
    def test_custom_log(self):
        ...
        with nostderrout():
            ...
            run_stata(program = 'gslab_make/tests/input/stata_test_script.do', makelog = makelog_file)
    ...
    def test_independent_log(self):
        ...
        with nostderrout():
            start_makelog(default_makelog)
            run_stata(program = 'gslab_make/tests/input/stata_test_script.do', log = independent_log)
        self.assertIn('end of do-file', open(default_makelog).read())
    ...
    def test_executable(self):
        ...
        with nostderrout():
            start_makelog(default_makelog)
            run_stata(program = 'gslab_make/tests/input/stata_test_script.do', executable = metadata.default_executables[os.name]['stata']) 
        self.assertIn('end of do-file', open(default_makelog).read())
    ...
    def test_bad_executable(self):
        ...
        with self.assertRaises(CritError):
            run_stata(program = 'gslab_make/tests/input/stata_test_script.do', executable = 'nonexistent_stata_executable')
    ...
    def test_no_program(self):
        ...
        with self.assertRaises(Exception):
            run_stata(program = 'gslab_make/tests/input/nonexistent_stata_script.do')
        self.assertNotIn('end of do-file', open(default_makelog).read())
