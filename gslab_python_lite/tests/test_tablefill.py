...
from gslab_python_lite import tablefill
...
class testTablefill(unittest.TestCase):
    ...
    def testInput(self):
        for ext in ['lyx', 'tex']:
            with nostderrout():
                message = tablefill(input    = 'gslab_python_lite/tests/input/tables_appendix.txt ' + \
                                               'gslab_python_lite/tests/input/tables_appendix_two.txt', 
                                    template = 'gslab_python_lite/tests/input/tablefill_template.%s' % ext, 
                                    output   = './build/tablefill_template_filled.%s' % ext)
            self.assertIn('filled successfully', message)
            tag_data = open('gslab_python_lite/tests/input/tablefill_template.%s' % ext, 'rU').readlines()
    ...
    def testBreaksRoundingString(self):
        for ext in ['lyx', 'tex']:
            with nostderrout():
                error = tablefill(input    =  'gslab_python_lite/tests/input/tables_appendix.txt ' + 
                                              'gslab_python_lite/tests/input/tables_appendix_two.txt', 
                                  template =  'gslab_python_lite/tests/input/tablefill_template_breaks.%s' % ext, 
                                  output   =  './build/tablefill_template_filled.%s' % ext)
    ...
    def testIllegalSyntax(self):
        ...
        for ext in ['lyx', 'tex']:
            with nostderrout():
                error = tablefill(input    = 'gslab_python_lite/tests/input/fake_file.txt ' + \
                                             'gslab_python_lite/tests/input/tables_appendix_two.txt', 
                                  template = 'gslab_python_lite/tests/input/tablefill_template_breaks.%s' % ext, 
                                  output   = './build/tablefill_template_filled.%s' % ext)
        ...
        for ext in ['lyx', 'tex']:
            with nostderrout():
                error = tablefill(input    = 'gslab_python_lite/tests/input/tables_appendix.txt ' + \
                                             'gslab_python_lite/tests/input/fake_file.txt', 
                                  template = 'gslab_python_lite/tests/input/tablefill_template_breaks.%s' % ext, 
                                  output   = './build/tablefill_template_filled.%s' % ext)
            self.assertIn('IOError', error)
        ...
        for ext in ['lyx', 'tex']:
            ...
            with nostderrout():
                message = tablefill(output   = './build/tablefill_template_filled.%s' % ext, 
                                    template = 'gslab_python_lite/tests/input/tablefill_template.%s' % ext, 
                                    input    = 'gslab_python_lite/tests/input/tables_appendix.txt ' + \
                                               'gslab_python_lite/tests/input/tables_appendix_two.txt')
            self.assertIn('filled successfully', message)
